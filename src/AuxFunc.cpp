...
double
AuxFunc::timeTT(int day, int month, int year, int hour, int minut,
                double sec, int belt)
{
  double a1, m1, c1, a2;
  ...
  J = static_cast<int>(std::floor(146097.0 * c1 / 4.0)) + static_cast<int>
      (std::floor(36525.0 * a2 / 100.0)) + static_cast<int>(std::floor(
  ...
  if(J >= 0)
    ...
    {
      double k = static_cast<double>(chh) / 24.0 + static_cast<double>
                 (chmin) / 1440.0 + chsec / 86400.0;
      k = 1 - k;
      JD = static_cast<double>(J) - k;
    }
  if(JD <= 2424151.5)
      ...
      if(JD <= 2299161.0)
        {
          ...
          J = static_cast<int>(std::floor(1461.0 *
                                          (static_cast<double>(chy) + a1) / 4.0)) + static_cast<int>(std::floor(
                                                (153.0 * m1 + 2.0) / 5.0)) + chd + 1721117;
          if(J >= 0)
            {
  ...
  if(ch != 0)
    {
      bool setdelta = false;
      double y = static_cast<double>(chy) + (static_cast<double>(chm) - 0.5) / 12.0;
      double u;
      if(chy < -500)
        {
      ...
      if(chy >= -500 && chy < 500)
        {
          u = y * 0.01;
          delta = 10583.6 - 1014.41 * u + 33.78311 * u * u - 5.952053 * u * u * u -
                  0.1798452 * u * u * u * u + 0.022174192 * u * u * u * u * u + 0.0090316521 * u *
                  u * u * u * u * u;
          setdelta = true;
        }
      if(chy >= 500 && chy < 1600)
        {
          ...
          delta = 1574.2 - 556.01 * u + 71.23472 * u * u + 0.319781 * u * u * u -
                  0.8503463 * u * u * u * u - 0.005050998 * u * u * u * u * u + 0.0083572073 * u *
                  u * u * u * u * u;
          setdelta = true;
        }
      ...
      if(chy >= 1700 && chy < 1800)
        {
          u = y - 1700.0;
          delta = 8.83 + 0.1603 * u - 0.0059285 * u * u + 0.00013336 * u * u * u - u * u *
                  u * u / 1174000.0;
          setdelta = true;
        }
      if(chy >= 1800 && chy < 1860)
        {
          u = y - 1800.0;
          delta = 13.72 - 0.332447 * u + 0.0068612 * u * u + 0.0041116 * u * u * u -
                  0.00037436 * u * u * u * u + 0.0000121272 * u * u * u * u * u - 0.0000001699 * u
                  * u * u * u * u * u + 0.000000000875 * u * u * u * u * u * u * u;
          setdelta = true;
        }
      ...
      if(chy >= 1900 && chy < 1920)
        {
          u = y - 1900.0;
          delta = -2.79 + 1.494119 * u - 0.0598939 * u * u + 0.0061966 * u * u * u -
                  0.000197 * u * u * u * u;
          setdelta = true;
        }
      if(chy >= 1920 && chy < 1941)
        {
          u = y - 1920.0;
          delta = 21.20 + 0.84493 * u - 0.076100 * u * u + 0.0020936 * u * u * u;
          setdelta = true;
        }
...
void
AuxFunc::toEcliptic(mpf_class *Oldx, mpf_class *Oldy,
                    ...
                    int ch)
{
  ...
  if(ch == 0)
    {
      e = mpf_class(84381.448) / mpf_class(3600) * mpf_class(M_PI) / mpf_class(180);
      *Newx = *Oldx;
...
void
AuxFunc::precessionNnut(mpf_class *Oldx, mpf_class *Oldy,
                        mpf_class *Oldz, mpf_class *Newx,
                        mpf_class *Newy, mpf_class *Newz, double JD)
{
  double P[3][3];
...
void
AuxFunc::rotateXYZ(mpf_class xyz[3], mpf_class rx,
