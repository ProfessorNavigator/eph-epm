...
template void
ByteOrder::form_native_order(int16_t &control);
template void
ByteOrder::form_native_order(int32_t &control);
template void
ByteOrder::form_native_order(int64_t &control);
template void
ByteOrder::form_native_order(uint16_t &control);
template void
ByteOrder::form_native_order(uint32_t &control);
template void
ByteOrder::form_native_order(uint64_t &control);
template void
ByteOrder::form_native_order(float &control);
template void
ByteOrder::form_native_order(double &control);
template <typename T>
void
...
template void
ByteOrder::form_inner(int16_t &val);
template void
ByteOrder::form_inner(int32_t &val);
template void
ByteOrder::form_inner(int64_t &val);
template void
ByteOrder::form_inner(uint16_t &val);
template void
ByteOrder::form_inner(uint32_t &val);
template void
ByteOrder::form_inner(uint64_t &val);
template void
ByteOrder::form_inner(float &val);
template void
ByteOrder::form_inner(double &val);
template <typename T>
void
...
template void
ByteOrder::get_native(int16_t &result);
template void
ByteOrder::get_native(int32_t &result);
template void
ByteOrder::get_native(int64_t &result);
template void
ByteOrder::get_native(uint16_t &result);
template void
ByteOrder::get_native(uint32_t &result);
template void
ByteOrder::get_native(uint64_t &result);
template void
ByteOrder::get_native(float &result);
template void
ByteOrder::get_native(double &result);
template <typename T>
void
